                                ...
                                <div class="container">
                                    <div class="text-right py-2">
                                        ...
                                        <div id="container-form">
                                            <div class="question-box container bg-white p-3 border border-secondary rounded questionBox">
                                                <label for="question" class="form-label">Question: </label>
                                                <input type="text" name="question[]" placeholder="Enter Question" class="form-control" />

                                                <div class=" container text-center py-3 option-container">
                                                    <table class="table my-2 table-borderless" >
                                                        <tbody id="table-option">
                                                          <tr>
                                                            <td class="align-middle">
                                                                <input type="text" name="option[]" placeholder="Option" class="form-control"/>
                                                            </td>
                                                          </tr>
                                                          <tr>
